...
@ApplicationScoped
public class PhonesResourceSteps extends BaseSteps {
    ...
    public void I_make_a_GET_request_on_phones_resource() throws Throwable {
        response = target.request().get();
        response.bufferEntity();
    }

    @Then("^I should get http response status as (\\d+) from phones resource$")
    public void I_should_get_http_response_status_as_from_phones_resource(int status) throws Throwable {
        assertEquals(response.getStatus(), status);
    }

    @And("^I should see number of phones as (\\d+) from phones resource$")
    public void I_should_see_number_of_phones_as_from_phones_resource(int phoneCount) throws Throwable {
    ...
    public void I_should_see_the_following_phone_summary_from_phones_resource(List<PhoneSummaryDataTable> phoneSummaryDataTableList) throws Throwable {
        List<PhoneSummaryEntity> phoneSummaryList = response.readEntity(new GenericType<List<PhoneSummaryEntity>>() {});
    ...
    public void I_should_be_able_to_get_image_for_every_phone_summary_from_phones_resource() throws Throwable {
        List<PhoneSummaryEntity> phoneSummaryList = response.readEntity(new GenericType<List<PhoneSummaryEntity>>() {});
